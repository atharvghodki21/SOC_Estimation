...
//		InfoText16.setBounds(157, 478, 834, 25);
//		add(InfoText16);
...
//		InfoText15.setBounds(157, 442, 834, 25);
//		add(InfoText15);
...
//		JLabel InfoText6 = new JLabel("In over every changing world, ancient batteries are responsible for increasing ");
//		InfoText6.setForeground(Color.BLUE);
//		InfoText6.setFont(new Font("Tahoma", Font.PLAIN, 21));
//		InfoText6.setBounds(157, 295, 834, 25);
//		add(InfoText6);
//
//		JLabel InfoText7 = new JLabel("the carbon footprints. Therefore we are switching towards more eco-friendly, ");
//		InfoText7.setForeground(Color.BLUE);
//		InfoText7.setFont(new Font("Tahoma", Font.PLAIN, 21));
//		InfoText7.setBounds(157, 331, 834, 25);
//		add(InfoText7);
//		
//		JLabel InfoText8 = new JLabel("efficient and environment suitable batteries.");
//		InfoText8.setForeground(Color.BLUE);
//		InfoText8.setFont(new Font("Tahoma", Font.PLAIN, 21));
//		InfoText8.setBounds(157, 367, 834, 25);
//		add(InfoText8);
//		
...
//		lblNewLabel.setBounds(0, 5, 941, 650);
		...
		ImageIcon img = new ImageIcon(this.getClass().getResource("/4.png"));
